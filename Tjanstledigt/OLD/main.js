...
router.get('/tusenklubben', function (req, res) {
    res.render('tusenklubben.ejs');
});


router.get('/slump', function (req, res) {
    res.render('slump.ejs');
});

router.get('/reglanding', function (req, res) {
...
router.get('/data/vecka', function (req, res) {
...
router.get('/newPlayerLanding', function (req, res) {
...
router.get('/removePlayer', function (req, res) {
...
router.get('/slumpPlayers', function (req, res) {
    db.collection("aktiva").find({}).toArray(function (err, data) {
        if (err) throw err
        // console.log('Inlagd spelare ' + resDB.insertedCount + ' - ' + req.body.playerNamn)
...
router.get('/statLanding', function (req, res) {
    res.render('statLanding.ejs');
});

router.get('/statsWeek', function (req, res) {
    var datum = new Date();
    var vecka = datum.getFullYear() + ' - ' + moment(datum, "MM-DD-YYYY").week()
...
router.get('/statsMonth', function (req, res) {
    var datum = new Date();
...
router.get('/statsVroom', function (req, res) {
...
router.get('/statsTotal', function (req, res) {
...
// router.listen(port, process.env.IP, function () {
